import { createVNode, mergeProps, Transition, toRefs, shallowRef, ref, computed, watch, nextTick, toRef, watchEffect, provide, onScopeDispose, withDirectives, vShow, Fragment, resolveDirective, reactive, inject as inject$1, onUnmounted, capitalize, h, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, defineComponent as defineComponent$1, camelize, unref, toRaw, readonly, TransitionGroup, isRef, Text, resolveDynamicComponent, effectScope, warn, Teleport, cloneVNode, createTextVNode, vModelText, useSSRContext, createApp, onErrorCaptured, onServerPrefetch, shallowReactive, isReadonly, defineAsyncComponent, isShallow, isReactive, resolveComponent, withCtx, Suspense } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-862f0b7c.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-f5b1c2a1.mjs').then((m) => m.default || m)
  },
  {
    name: "links",
    path: "/links",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-1501da26.mjs').then((m) => m.default || m)
  },
  {
    name: "opens",
    path: "/opens",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-aca8a93a.mjs').then((m) => m.default || m)
  },
  {
    name: "videos",
    path: "/videos",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-ecf7e38c.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-8473f573.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-8efad826.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-9e71423e.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-192c1fb7.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { _export_sfc as _, createError as c, entry$1 as default, navigateTo as n, useRouter$1 as u };
